...
cap = cv2.VideoCapture(0)  # 0 is usually the default camera for laptops
...
smoothing_factor = 0.2  # Smoothing factor for servo movement (0 to 1)
...
while True:
    ...
    if contours:
        ...
        pan_angle = constrain_angle(pan_angle, 0, 180)  #pan_angle = max(0, min(180, pan_angle))
